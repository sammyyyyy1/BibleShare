...
**Interfaces:**
- Produces: `private.checkin_cron_health() → table(last_success_at timestamptz, minutes_since_success numeric, failed_runs_last_hour bigint, invalid_timezone_groups bigint)`
